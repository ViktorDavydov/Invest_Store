...
2. В class <Model>Form под классом Meta дописываем clean метод, например def clean_email(self): cleaned_data = self.cleaned_data['email'] - тут в квадратных скобках название поля модели, которое валидируем.
